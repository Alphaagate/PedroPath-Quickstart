...
//    private TurretMechanism4 turret = new TurretMechanism4();
    ...
    public void buildPaths() {
        ...
        driveStartToShoot = follower.pathBuilder()
                .addPath(new BezierLine(
                        ...
                        new Pose(55.884, 88.526, Math.toRadians(145))
                ))
        ...
        driveToSet2 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(55, 88.526, Math.toRadians(145)),
                        new Pose(62, 54.832, Math.toRadians(180)),
                        new Pose(25.5, 57.5, Math.toRadians(180))
                ))
        ...
        driveSet2ToShoot = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Pose(26.5, 57.5, Math.toRadians(180)),
        ...
        driveToGate = follower.pathBuilder()
                .addPath(new BezierCurve(
                        ...
                        new Pose(22, 66, Math.toRadians(180))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        adjust = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Pose(22, 66, Math.toRadians(180)),
                        new Pose(17.5, 64, Math.toRadians(148))
                ))
        ...
        driveGateToShoot = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(17.5, 64, Math.toRadians(180)),
        ...
        driveToSet1 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Pose(60.884, 84.526, Math.toRadians(180)),
                        new Pose(26.5, 84.091, Math.toRadians(180))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        driveSet1ToShoot = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Pose(26.5, 84.091, Math.toRadians(180)),
                        new Pose(54.884, 110, Math.toRadians(180))
                ))
        ...
        driveToSet3 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        ...
                        new Pose(25.5, 36, Math.toRadians(180))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        driveSet3ToShoot = follower.pathBuilder()
                .addPath((new BezierLine(
                        new Pose(25.5, 36, Math.toRadians(180)),
                        new Pose(60.884, 100.526, Math.toRadians(180)))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        driveToEnd = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Pose(60.884, 84.526, Math.toRadians(180)),
                        new Pose(59.946, 120, Math.toRadians(180))
                ))
